      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-1 text-sm text-muted-foreground flex-wrap">
            ...
            {(vendor as any).whatsappNumber && (
              <a href={`https://wa.me/${((vendor as any).whatsappNumber as string).replace(/[^0-9]/g, '')}`}
                target="_blank" rel="noopener noreferrer"
          ...
          {editForm && (
            <div className="space-y-3 py-2">
              ...
              <div>
                ...
                <Input className="mt-1" placeholder="e.g. +8613800138000"
                  value={(editForm as any).whatsappNumber ?? ""}
                  onChange={(e) => setEditForm({ ...editForm, whatsappNumber: e.target.value } as any)} />
                <p className="text-xs text-muted-foreground mt-1">Include country code (e.g. +86 for China).</p>
              </div>
              <div>
